...
INSERT INTO "turn" ("uuid", "status", "creation_date", "formation_date", "completion_date", "moderator_id", "customer_id", "phase") VALUES
...
INSERT INTO "card" ("uuid", "name", "image_url", "type", "description", "is_deleted") VALUES
...
ALTER TABLE ONLY "public"."played_cards" ADD CONSTRAINT "fk_played_cards_turn" FOREIGN KEY (turn_id) REFERENCES turn(uuid) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."played_cards" ADD CONSTRAINT "fk_played_cards_card" FOREIGN KEY (card_id) REFERENCES card(uuid) NOT DEFERRABLE;

ALTER TABLE ONLY "public"."turn" ADD CONSTRAINT "fk_turns_customer" FOREIGN KEY (customer_id) REFERENCES users(uuid) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."turn" ADD CONSTRAINT "fk_turns_moderator" FOREIGN KEY (moderator_id) REFERENCES users(uuid) NOT DEFERRABLE;